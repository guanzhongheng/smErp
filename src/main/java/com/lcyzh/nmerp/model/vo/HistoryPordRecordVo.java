...
public class HistoryPordRecordVo extends DataEntity<HistoryPordRecordVo> {
    ...
    public Long getHistoryProdRecordId() {
        return historyProdRecordId;
    }

    public void setHistoryProdRecordId(Long historyProdRecordId) {
        this.historyProdRecordId = historyProdRecordId;
    }
