...
import com.lcyzh.nmerp.common.utils.Collections3;
import com.lcyzh.nmerp.common.utils.Global;
import com.lcyzh.nmerp.common.utils.RoleListType;
...
public class User extends DataEntity<User> {
	...
	@ExcelField(title="用户类型",  sort=80, dictType="sys_user_type")
	...
	@ExcelField(title="最后登录IP", sort=100)
	...
	@ExcelField(title="最后登录日期", sort=110)
	...
	@JsonIgnore
	@ExcelField(title="拥有角色", sort=800, fieldType= RoleListType.class)
