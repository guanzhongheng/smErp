...
public class UserUtils {
	...
	private static TSysUserMapper userDao = SpringContextHolder.getBean(TSysUserMapper.class);
	private static TSysRoleMapper roleDao = SpringContextHolder.getBean(TSysRoleMapper.class);
	private static TSysMenuMapper menuDao = SpringContextHolder.getBean(TSysMenuMapper.class);
