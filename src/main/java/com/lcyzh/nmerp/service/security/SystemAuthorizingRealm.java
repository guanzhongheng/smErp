...
//		}
	...
	protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken authenticationToken) throws AuthenticationException {
		org.apache.shiro.authc.UsernamePasswordToken token = (UsernamePasswordToken)authenticationToken;
		try{
			// TUserInfo user = service.findByUserName(token.getUsername());
			ByteSource salt = ByteSource.Util.bytes("admin");
			return new SimpleAuthenticationInfo("admin", "123", salt, getName());
		}catch (Exception e){
			return null;
		}
	}
