...
public class SendGoodsInfo implements Serializable {
    ...
    public void setSgiCode (String sgiCode) {this.sgiCode = sgiCode;} 
    public String getSgiCode(){ return sgiCode;} 
    public void setDriverName (String driverName) {this.driverName = driverName;} 
    public String getDriverName(){ return driverName;} 
    public void setDriverPhone (String driverPhone) {this.driverPhone = driverPhone;} 
    public String getDriverPhone(){ return driverPhone;} 
    public void setDriverCarNo (String driverCarNo) {this.driverCarNo = driverCarNo;} 
    public String getDriverCarNo(){ return driverCarNo;} 
