(function ($) {
    ...
    BootstrapTable.prototype.initFixedColumns = function () {
        ...
        if (this.options.leftFixedColumns) {
            this.$fixedBody = $([
                '<div class="fixed-table-column" style="position: absolute; border-right:1px solid #ddd;">',
                '<table>',
                '<thead></thead>',
                '<tbody></tbody>',
                '</table>',
        ...
        if (this.options.rightFixedColumns) {
            this.$rightfixedBody = $([
                '<div class="fixed-table-column" style="position: absolute;right:0px; border-right:1px solid #ddd;">',
                '<table>',
                '<thead></thead>',
                '<tbody></tbody>',
                '</table>',
