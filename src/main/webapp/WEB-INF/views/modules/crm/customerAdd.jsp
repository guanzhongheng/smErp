                    ...
                    <div class="col-sm-6 b-r">
                        <div class="ibox float-e-margins">
                            <form method="get" class="form-horizontal">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <form:select path="industry" cssClass="chosen-select global-input"
                                            ...
                                            <form:options items="${fns:getCusDictList(120000)}" itemLabel="label"
                                    ...
                                    <div class="col-sm-8">
                                        <div class="radio i-checks">
                                            ...
                                            <c:if test="${not empty customerAddModifyVo.cusType}">
                                                <input type="radio" ${customerAddModifyVo.cusType eq '110002' ? 'checked' : ''}
                                                       value="110002" id="optionsRadios1"
                                                       name="cusType"><i></i>&nbsp;经销商
                                            </c:if>
                                            <input type="radio" ${customerAddModifyVo.cusType eq '110001' ? 'checked' : ''}
                                                   value="110001" id="optionsRadios2"
                                                   name="cusType"><i></i>&nbsp;散户
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <form:select path="cusStatus" class="chosen-select"
                                                     cssStyle="min-width: 300px">
                                            <form:option value="" label=""/>
                                            <form:options items="${fns:getCusDictList(104000)}" itemLabel="label"
                                                          itemValue="value" htmlEscape="false"/>
                                        </form:select>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <form:select path="cusGrade" class="chosen-select"
                                                     cssStyle="min-width: 300px">
                                            <form:option value="" label=""/>
                                            <form:options items="${fns:getCusDictList(105000)}" itemLabel="label"
                                                          itemValue="value" htmlEscape="false"/>
                                        </form:select>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <form:select path="cusSource" class="chosen-select"
                                                     cssStyle="min-width: 300px">
                                            <form:option value="" label=""/>
                                            <form:options items="${fns:getCusDictList(106000)}" itemLabel="label"
                                                          itemValue="value" htmlEscape="false"/>
                                        </form:select>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <label class="col-sm-3 control-label">归属人员：</label>
                                    <div class="col-sm-8">
                                        <select id="cusContent" name="empCode" class="chosen-select"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <form:textarea path="remarks" htmlEscape="false"
                                                       cssClass="form-control global-input"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <select id="cusContent2" name="followEmpCode" class="chosen-select"
                                                style="min-width: 300px">
                                            <c:forEach items="${userList}" var="us">
                                                <option value="${us.id}">${us.name}</option>
                                            </c:forEach>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <form:textarea path="followDetail" htmlEscape="false"
                                                       cssClass="form-control global-input"
                                                       cssStyle="min-width: 300px;" rows="6" maxlength="100"/>
                                    </div>
                                </div>
                            ...
                            <div class="col-sm-8">
                                <div class="radio i-checks">
                                    ...
                                    <c:if test="${not empty customerAddModifyVo.primaryContactorSex}">
                                        <input type="radio" name="primaryContactorSex"
                                               value="108003" ${customerAddModifyVo.primaryContactorSex eq '108003' ? 'checked' : ''}>
                                        <i></i>未知
                                    </c:if>
                                    <input type="radio" name="primaryContactorSex"
                                           value="108001" ${customerAddModifyVo.primaryContactorSex eq '108001' ? 'checked' : ''}>
                                    <i></i>先生
                                    <input type="radio" name="primaryContactorSex"
                                           value="108002" ${customerAddModifyVo.primaryContactorSex eq '108002' ? 'checked' : ''}>
                                    <i></i>女士
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                ...
                                <form:select path="primaryContactorRole" class="chosen-select"
                                             cssStyle="min-width: 300px">
                                    <form:options items="${fns:getCusDictList(130000)}" itemLabel="label"
                                                  itemValue="value" htmlEscape="false"/>
                                </form:select>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                ...
                                <form:select path="primaryContactorDepartment" class="chosen-select"
                                             cssStyle="min-width: 300px">
                                    <form:options items="${fns:getCusDictList(109000)}" itemLabel="label"
                                                  itemValue="value" htmlEscape="false"/>
                                </form:select>
                            </div>
                        </div>
